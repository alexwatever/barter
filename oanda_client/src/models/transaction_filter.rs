...
impl std::fmt::Display for TransactionFilter {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::OneCancelsAllOrder => write!(f, "ONE_CANCELS_ALL_ORDER"),
            Self::OneCancelsAllOrderReject => write!(f, "ONE_CANCELS_ALL_ORDER_REJECT"),
            Self::OneCancelsAllOrderTriggered => write!(f, "ONE_CANCELS_ALL_ORDER_TRIGGERED"),
