...
pub struct ReplaceOrder404Response {
    #[serde(rename = "orderCancelRejectTransaction", skip_serializing_if = "Option::is_none")]
    pub order_cancel_reject_transaction: Option<Box<models::Transaction>>,
...
impl ReplaceOrder404Response {
    pub fn new() -> ReplaceOrder404Response {
