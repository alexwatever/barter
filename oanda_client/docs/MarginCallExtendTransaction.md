...
**r#type** | Option<**String**> | The Type of the Transaction. Always set to \"MARGIN_CALL_EXTEND\" for an MarginCallExtendTransaction. | [optional]
**extension_number** | Option<**i32**> | The number of the extensions to the Account's current margin call that have been applied. This value will be set to 1 for the first MarginCallExtend Transaction | [optional]
