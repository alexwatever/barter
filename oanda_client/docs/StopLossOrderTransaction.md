...
**r#type** | Option<**String**> | The Type of the Transaction. Always set to \"STOP_LOSS_ORDER\" in a StopLossOrderTransaction. | [optional]
...
**guaranteed_execution_premium** | Option<**String**> | The fee that will be charged if the Stop Loss Order is guaranteed and the Order is filled at the guaranteed price. The value is determined at Order creation time. It is in price units and is charged for each unit of the Trade. | [optional]
