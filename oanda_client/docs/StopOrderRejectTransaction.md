...
**r#type** | Option<**String**> | The Type of the Transaction. Always set to \"STOP_ORDER_REJECT\" in a StopOrderRejectTransaction. | [optional]
**instrument** | Option<**String**> | The Stop Order's Instrument. | [optional]
**units** | Option<**String**> | The quantity requested to be filled by the Stop Order. A posititive number of units results in a long Order, and a negative number of units results in a short Order. | [optional]
**price** | Option<**String**> | The price threshold specified for the Stop Order. The Stop Order will only be filled by a market price that is equal to or worse than this price. | [optional]
**price_bound** | Option<**String**> | The worst market price that may be used to fill this Stop Order. If the market gaps and crosses through both the price and the priceBound, the Stop Order will be cancelled instead of being filled. | [optional]
**time_in_force** | Option<**String**> | The time-in-force requested for the Stop Order. | [optional]
**gtd_time** | Option<**String**> | The date/time when the Stop Order will be cancelled if its timeInForce is \"GTD\". | [optional]
...
**reason** | Option<**String**> | The reason that the Stop Order was initiated | [optional]
